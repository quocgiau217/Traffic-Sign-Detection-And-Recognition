...
for line in tqdm(annotation_file):
    ...
    if int(data[0].split('.')[0]) not in missing_img:
        ...
        image = cv2.imread('F:\Traffic-Sign-Detection-And-Recognition\Data Preparation\FullIJCNN2013_jpg' + "\\" + img_name + ".jpg")
